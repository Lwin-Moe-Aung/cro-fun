    ...
    <div class="container-fluid" style="margin-bottom: 150px;margin-top:100px;">
        <div class="row" style="margin-top: 15px;">
            ...
            <div class="col-md-9" >
                ...
                @endif
                <p class="title">Field Officers Listing</p>
                <br>
                                <div class="table-responsive finance" >
                                    <table id="users" class="table table-hover table-bordered" style="position:relative;">
                                        <thead>
                                        <tr>
                                            <th>Id</th>
                                            <th>Code No</th>
        ...
        $(document).ready(function() {
           var user= $('#users').DataTable({
                ...
                "columns": [
                    ...
                    {data: 'name', name: 'name'},
                    {data: 'nrc', name: 'nrc'},
                    {data: 'dob', name: 'dob',type: 'date-dd-mmm-yyyy', targets: 0},
                ...
                "buttons": [
                    {
                       // extend: 'excel',
                        ...
                        action: function (e, dt, node, config)
                        {
                            ...
                            $.ajax({
                                method: "GET",
                                url: "/officers/getdata?"+$.param(data),
           ...
           $('#users').hover(function(){
            ...
            $(document).delegate('.btn-warning', 'click', function(e) {
                ...
                if (confirm("Do you really want to delete this field officer's record")) {
